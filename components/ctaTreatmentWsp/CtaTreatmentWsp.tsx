...
export const CtaTreatmentWsp = () => {
  return (
    <div className='container max-w-[1200px] mx-auto my-16 lg:my-32'>
        <div className='flex flex-col justify-center mx-auto md:flex-row bg-in-pink max-w-[500px] md:max-w-none rounded-tl-full rounded-tr-full md:rounded-tl-[140px] md:rounded-bl-[140px] gap-0 md:gap-4 items-center w-10/12 rounded-lg'>
