...
export const HeroLaserTreatment = () => {
  ...
  return (
    <div className="relative min-h-[480] md:min-h-screen">
      ...
      <div className="bottom-4 md:top-auto md:translate-y-0 absolute text-center max-w-[1200px] lg:left-1/2 lg:-translate-x-1/2 flex flex-col items-center md:bottom-12 space-y-2 md:space-y-4 text-white px-6 lg:px-0">
        <p className="text-lg md:text-xl">Nuestro tratamiento con</p>
        <h2 className="text-center font-in-playfair text-3xl lg:text-6xl">Láser CO2 DEKA</h2>
        <p className="text-sm md:text-base">Es la solución más avanzada para eliminar lunares, verrugas y acrocordones sin dolor ni marcas. Es un procedimiento rápido, seguro y eficaz, realizado por especialistas en estética avanzada.</p>
