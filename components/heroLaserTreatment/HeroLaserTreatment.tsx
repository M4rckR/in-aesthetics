...
export const HeroLaserTreatment = () => {
  return (
    <div className="relative min-h-[480] md:min-h-screen">
      ...
      <div className="top-1/2 -translate-y-1/2 md:top-auto md:translate-y-0 absolute text-center max-w-[1200px] lg:left-1/2 lg:-translate-x-1/2 flex flex-col items-center md:bottom-12 space-y-4 text-white px-6 lg:px-0">
        <p className="text-xl">Nuestro tratamiento con</p>
